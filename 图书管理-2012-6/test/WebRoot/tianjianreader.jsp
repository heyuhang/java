 ...
 <div id="d" style="position:absolute;display:none;left:365px" onmousemove="Show('d');" onmouseout="Close('d')">
  ...
  <ul>
   ...
   <li><a href="/test/ba?method=booreturn">图书归还</a></li>
	...
	<div id="temp1">
	<form action="/test/ba?method=insert2" method="post">
      <table width="544" border="0">
        <tr> 
          <th width="326" height="42" ><div align="right">姓名：</div></th>
          <th width="208" ><input type="text" name="name"/></th>
        </tr>
        <tr> 
          <th height="36" ><div align="right">性别：</div></th>
          <th><input type="text" name="sex"/></th>
        </tr>
        <tr> 
          <th height="36" ><div align="right">条形码：</div></th>
          <th><input type="text" name="barcode"/></th>
        </tr>
        <tr> 
          <th height="30" ><div align="right">职员：</div></th>
          <th><input type="text" name="vocation"/></th>
        </tr>
        <tr> 
          <th height="38" ><div align="right">出生日期：</div></th>
          <th><input type="text" name="birthday"></th>
        </tr>
        <tr> 
          <th height="37" ><div align="right">有效证件：</div></th>
          <th><select name="paperType" />
            <option value="身份证">省份证</option> <option value="学生证">学生证</option> 
            <option value="图书证">图书证</option></select>
            </th>
        </tr>
        <tr> 
          <th height="46" ><div align="right">证件号码：</div></th>
          <th><input type="text" name="paperNO"/></th>
        </tr>
        <tr> 
          <th height="56" ><p align="right">电话：</p></th>
          <th><input type="text" name="tel"/></th>
        </tr>
        <tr> 
          <th height="59" ><div align="right">电子邮件：</div></th>
