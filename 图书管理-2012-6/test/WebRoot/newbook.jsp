...
<div id="center" style="z-index:1">	
 ...
 <div id="d" style="position:absolute;display:none;left:365px" onmousemove="Show('d');" onmouseout="Close('d')">
  ...
  <form action="/test/ba?method=findone" method="post">
  <p>请输入读者条形码： 
    <input name="barcode" type="text" size="40" height="30"/>
  ...
  <div id="temp5"> 
	...
	%>
      <tr style="background:#fff;"> 
        ...
        <th><%=g.getPwd() %></th>
        <th><%=g.getID()%></th>
        <th width="124"><a href="/test/ba?method=renewbook&barcode=<%=g.getbarcode()%>">归还</a></th>
      </tr>
      <%} %> 
    </table>
  </div>
