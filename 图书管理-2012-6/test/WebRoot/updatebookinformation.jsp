 ...
 <div id="d" style="position:absolute;display:none;left:365px" onmousemove="Show('d');" onmouseout="Close('d')">
  ...
  <ul>
   ...
   <li><a href="/test/ba?method=booreturn">图书归还</a></li>
	...
	<form action="/test/ba?method=update" method="post">
      <table width="544" border="0">
        <tr> 
          <th width="326" height="42" ><div align="right">条形码：</div></th>
          <th width="208" ><input type="text"  name="barcode" value="<%=book.getBarcode() %>"/></th>
        </tr>
        <tr> 
          <th height="36" ><div align="right">图书名称：</div></th>
          <th><input type="text"  name="bookname" value="<%=book.getbooknsme() %>"/></th>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <th><input type="text" name="author" value="<%=book.getauthor() %>"/></th>
        </tr>
        <tr> 
          <th height="38" ><div align="right">译者：</div></th>
          <th><input type="text"  name="translator" value="<%=book.gettranslator() %>"/></th>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <th><input type="text"  name="page" value="<%=book.getpage() %>"/></th>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <th><input type="text" name="storage" value="<%=book.getstorage() %>"/></th>
        </tr>
	 	<tr> 
          <th height="48" >&nbsp;</th>
