   ...
   <table height="235" border="0">
      <tr >
        ...
        <th height="181"> 
				...
				<p ><form action="/test/ba?method=findone2" method="post"><input type="text" name="barcode" value="<%=obj.getBarcode()%>"/><input type="submit" value="确定"/></form><p>
				</div>
				<div id="temp3" style="float:left;">
				<p>姓&nbsp;&nbsp;&nbsp;名： <input type="text" size="20" name="name" value="<%=obj.getName() %>"></p>
				<p>证件类型：<input type="text" size="20" name="paperType" value="<%=obj.getPaperType() %>"></p>
				<p>读者类型：<input type="text" size="20" name="vocation" value="<%=obj.getVocation() %>"></p>
				</div>
				<div id="temp4" style="float:right;">
				<div>性&nbsp;&nbsp;&nbsp;别： <input type="text" size="20" name="sex" value="<%=obj.getSex() %>" /></div>
				<p>证件号码：<input type="text" size="20" name="paperNO" value="<%=obj.getpaperNO() %>"></p>
				<p>可借数量：<input type="text" size="20" name="number" value="<%=obj.getNumber() %>"></p>
				</div>
				</th>
			</tr>
		</table>
