...
<%JSP:response.setHeader("Charset","GBK"); %>
<html>
  <head>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="/base/resources/images/tab_05.gif" align="left"><img src="/base/resources/images/311.gif" width="16" height="16" /> <span class="STYLE4">用户添加</span></td>
      ...
      <tr>
        ...
        <td width="97%" bgcolor="#FFFFFF"  valign="top" align="center" height="500" style="padding-top:20px">
			...
			<tr style="width:100%; height:250px; background: url(/base/resources/images/htbg3.gif) repeat-y; text-align:center;">
				<td>
				<form action="/base/user?action=adduser" method="post" id="Form">
				<table width="505px" border="0" cellspacing="0" cellpadding="0">
				  <tr>
				  ...
				  <tr>
					...
					<td height="20" align="left"><input type="password" name="password" id="password"/></td>
				  	<td height="30" width="50%"><span id="passmsg" class="msg"></span></td>
				  </tr>
				  <tr>
				  
					<td height="30" align="right" class="STYLE4">确认密码：</td>
					<td height="20" align="left"><input type="password" name="confirm" id="confirm"/></td>
				  ...
				  <tr>
					...
					<td height="20" align="left"><input id="createTime" type="text" name="ctime"/>
