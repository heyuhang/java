...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="/base/resources/images/tab_05.gif" align="left"><img src="/base/resources/images/311.gif" width="16" height="16" /> <span class="STYLE4">供应商修改</span></td>
  ...
  <tr>
    ...
    <td align="left"><input dataType="Require" type="text" name="vendorName" msg="供应商名称必填" value="<%=vendor.getSuname()%>"/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input dataType="Zip" type="text" name="postcode" msg="邮编格式(6位数字)" value="<%=vendor.getSpost()%>"/></td>
  </tr>
  <tr>
    <td width="20%" height="30" align="right" class="STYLE4">固定电话：</td>
    <td align="left"><input  dataType="Phone" type="text" name="telphone" msg="电话格式：区号-电话" value="<%=vendor.getSphone()%>"/></td>
  </tr>
  <tr>
    <td width="20%" height="30" align="right" class="STYLE4">联&nbsp;&nbsp;系&nbsp;&nbsp;人：</td>
    <td align="left"><input dataType="Chinese" type="text" name="contact" msg="输入中文名字" value="<%=vendor.getSlpeople()%>"/></td>
  </tr>
  <tr>
