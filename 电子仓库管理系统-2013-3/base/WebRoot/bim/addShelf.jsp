...
<form action="/base/shelf?action=addshelf" method="post" name="form">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="/base/resources/images/tab_03.gif" width="15" height="30" /></td>
        <td background="/base/resources/images/tab_05.gif" align="left"><img src="/base/resources/images/311.gif" width="16" height="16" /> <span class="STYLE4">货架添加</span></td>
						...
						<table width="468" border="0" cellspacing="0" cellpadding="0" height="202">
						  ...
						  <tr>
						   ...
						   <tr>
							...
							<input type="button" onclick="check()" value="添加"  class="bt_02"/>&nbsp; 
