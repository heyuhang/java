...
<body>
<%
	goodsbrand goodsbrand=(goodsbrand)request.getAttribute("goodsbrand");
 %>
  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="/base/resources/images/tab_05.gif" align="left"><img src="/base/resources/images/311.gif" width="16" height="16" /> <span class="STYLE4">品牌修改</span></td>
      ...
      <tr>
        ...
        <td width="97%" bgcolor="#FFFFFF"  valign="top" align="center" height="500" style="padding-top:20px">
			...
			<tr style="width:100%; height:250px; background: url(/base/resources/images/htbg3.gif) repeat-y; text-align:center;">
				<td>
				<form action="/base/brand?action=updatebrandx&id=<%=goodsbrand.getId() %>" method="post" onSubmit="" >
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					   <tr>
							<td width="25%" height="30" align="right" class="STYLE4">品牌名称：</td>
							<td align="left"><input type="text" name="brandName" value="<%=goodsbrand.getBrname()%>"/>
							</td>
						</tr>
						<tr>
							<td height="20" align="right" class="STYLE4">描&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;述：</td>
							<td height="20" align="left"><textarea name="comments" cols="40" rows="4"><%=goodsbrand.getBrdescription() %></textarea></td>
						</tr>
						<tr>
