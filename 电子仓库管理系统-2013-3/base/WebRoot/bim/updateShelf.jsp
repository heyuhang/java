...
<%
 ...
 %>
<form action="/base/shelf?action=updateshelfx&id=<%=shelf.getId() %>" method="post" onSubmit="">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="30"><img src="/base/resources/images/tab_03.gif" width="15" height="30" /></td>
        <td background="/base/resources/images/tab_05.gif" align="left"><img src="/base/resources/images/311.gif" width="16" height="16" /> <span class="STYLE4">货架修改</span></td>
					...
					<td>
						<table width="468" border="0" cellspacing="0" cellpadding="0" height="202">
						  <tr>
							...
							<td align="left"><input type="text" name="shelfName" value="<%=shelf.getShname()%>"/></td>
						  </tr>
						  <tr>
							<td width="20%" height="30" align="right" class="STYLE4">描&nbsp;&nbsp;&nbsp;&nbsp;述：</td>
							<td align="left"><textarea name="comment" cols="40" rows="5"><%=shelf.getShdescription()%></textarea></td>
						  </tr>
						  <tr>
