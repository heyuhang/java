...
public class SearchAction extends ActionSupport{
	...
	public String execute()throws Exception{
		List list=fd.FindByPageTitle(PageNow, PageSize,label);
		...
		if(fd.FindCount(label,"search")%PageSize>0){
			TolePage=fd.FindCount(label,"search")/PageSize+1;
		}else TolePage=fd.FindCount(label,"search")/PageSize;
