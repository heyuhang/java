...
<div id="wrap">
<div class="content">
<div style="padding:10px 20px;color:rgb(209,78,8);font-weight:bold">关于<s:property value="label"/>技术:</div>
  <div id="left">
...
<s:if test="TolePage>1">
   <s:url id="url_pre" value="sort?label=%{label}&">
         <s:param name="PageNow" value="PageNow-1"></s:param>
   </s:url>
   <s:url id="url_next" value="sort?label=%{label}&">
         <s:param name="PageNow" value="PageNow+1"></s:param>
    </s:url>
    <s:url id="url_now" value="sort?label=%{label}&">
   ...
   <s:iterator value="fileu" status="fileu">
        <s:url id="url" value="sort?label=%{label}&">
	...
	<s:bean name="org.apache.struts2.util.Counter" id="counter">
		...
		<s:iterator>
    		...
    		<span id="s"><a href="sort?label=<s:property value="label"/>&PageNow=<s:property/>"><s:property/></a></span>
    		</s:if>
    		<s:else>
